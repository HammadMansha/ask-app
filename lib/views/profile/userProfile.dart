...
class UserProfile extends StatelessWidget {
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: CommonButton(
                                        ...
                                        textStyle: CommonTextStyle.style1,
                                        onPressed: () async {
                                          Get.toNamed(Routes.askquestionUser,
                                              arguments: {
                                                "userId" : _.userId,
                                                "userName" : _.userProfile!.user!.firstName,
                                              },);
                                        },
                                        fillColor: AppColors.buttonColor,
                                      ),
  ...
  Widget questionContainer(UserProfileController _) {
  ...
  Widget answerContainer(UserProfileController _) {
  ...
  void openBottomSheet(UserProfileController _) {
    Get.bottomSheet(
