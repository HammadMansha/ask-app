       ...
       return Container(
         ...
         child: SingleChildScrollView(
           child: Column(
             ...
             children: [
               Text("${AppStrings.welcomeBack}",style: CommonTextStyle.style2,).marginOnly(top: 50,left: 50),
               Text("${AppStrings.username}",style: CommonTextStyle.style3,).marginOnly(top: 0,left: 50),
               CommonTextField(
                 controller: _.email,
                 hintText: "Email",
               ...
               Center(
                 child: Text("Remember Password").marginOnly(top: 36,bottom: 36),
                 
               ),
               Center(
                 child: CommonButton(text: "Log in", textStyle: CommonTextStyle.style1, onPressed: (){
               ...
               GestureDetector(
                 ...
                 child: Center(
                   child: Text("Forgot Password?").marginOnly(top: 36,bottom: 36),

                 ),
               ),
               Center(child: Image.asset("${AppAssets.colorfulAsk}",height: 30,width: 30,),).marginOnly(top: 40),
             ],
