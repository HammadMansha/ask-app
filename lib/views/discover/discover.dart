            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${AppStrings.discover}",style: CommonTextStyle.style2,).marginOnly(top: 25,left:25),
                  Center(
                      child: Container(
                        width: Get.width/1.7,
                        height: 45,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              width: 100,
                              height: 40,
                              child: Center(child: Text("${AppStrings.public}",style: CommonTextStyle.style1,)),
                            ...
                            Container(
                              ...
                              child: Center(child: Text("${AppStrings.follower}",style: CommonTextStyle.style4,)),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Center(
                                    child:
                                    Text("${AppStrings.discoverUsername}",style: CommonTextStyle.style6font10weight400black,).marginOnly(top: 15,left: 9),

                                  ),
                                  Text("${AppStrings.discoverPostTime}",style: CommonTextStyle.style6font10weight400,).marginOnly(top: 12,left: 9),
                                  Spacer(),
                                  Icon(Icons.location_on,color:AppColors.buttonColor, size: 12,).marginOnly(top: 15),
                                  Text("${AppStrings.discoverPostTLocation}",style: CommonTextStyle.style6font10weight400,).marginOnly(top: 15,left: 3,right: 15),
                              ...
                              Text("${AppStrings.public}",style: CommonTextStyle.style6font10weight400,).marginOnly(top: 5,left: 25,right: 15),
                              Text("${AppStrings.discoverPostContent}",style: CommonTextStyle.style5font14weight500,maxLines: 3,overflow: TextOverflow.ellipsis,).marginOnly(top: 5,left: 25,right: 15),
                              ...
                              Row(children: [
                                ...
                                Text("1.1k",style: CommonTextStyle.style4,).marginOnly(left: 8,right: 14),
                                Image.asset("${AppAssets.comment}"),
                                Text("1.1k",style: CommonTextStyle.style4,).marginOnly(left: 8,right: 15),
